...
export const COMMENTS: CommentT[] = [
  {
    ...
    text: "A disciplined and creative individual who, in addition to developing the company's projects, managed her team properly",
  },
  {
    id: 2,
    ...
    link: "https://instagram.com",
    text: "A young but experienced developer with deep knowledge. we were able to easily move complex projects forward together",
  },
  {
    id: 3,
    ...
    link: "https://instagram.com",
    text: "A good and friendly colleague, in addition to her professional ethics, he can correctly convert designs into code",
  },
  {
    id: 4,
    ...
    text: "He was a creative and friendly leader for the front-end team, and he handled the heavy lifting well when we were working on multiple projects at the same time",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    position: "IT admin",
    link: "https://instagram.com",
    text: "He is a creative person and in addition to his technical knowledge, he can create interesting ideas. I would like to start a business together",
  },
];
